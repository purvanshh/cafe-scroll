...
export function Component() {
    ...
    useEffect(() => {
        ...
        const initApplication = async () => {
            ...
            const slides = [
                { title: "Pure Extraction", description: "Precision brewing for the perfect cup.", media: "https://images.unsplash.com/photo-1541167760496-1628856ab772?q=80&w=2670&auto=format&fit=crop" },
                ...
                { title: "Bean Journey", description: "From farm to cup, handled with care.", media: "https://images.unsplash.com/photo-1511537632536-b71c27caa929?q=80&w=2680&auto=format&fit=crop" }
            ];
    ...
    return (
        <div className="relative w-full h-full min-h-[80vh] bg-black text-white overflow-hidden font-sans">
            <main className="slider-wrapper absolute inset-0 opacity-0 transition-opacity duration-1000 loaded:opacity-100" ref={containerRef}>
            ...
            {/* Styles injected here for scope/simplicity, matching the "provided" structure implies self-containment for demo props */}
            <style jsx global>{`

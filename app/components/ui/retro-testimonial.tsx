        ...
        <>
                    ...
                    <div className="fixed inset-0 h-screen overflow-hidden z-50">
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                className="px-0 md:px-20 text-[#1f1b1d]/70 text-lg font-thin underline underline-offset-8"
                            >
                                {testimonial.designation}
                            </motion.p>
                            <motion.p
                                layoutId={layout ? `title-${testimonial.name}` : undefined}
                                className="px-0 md:px-20 text-2xl md:text-4xl font-normal italic text-[#1f1b1d]/70 mt-4 lowercase"
                            >
                                {testimonial.name}
                            </motion.p>
                            <div className="py-8 text-[#1f1b1d]/70 px-0 md:px-20 text-3xl lowercase font-thin leading-snug tracking-wide">
            ...
            >
                ...
                >
                    ...
                    <motion.p
                        layoutId={layout ? `title-${testimonial.name}` : undefined}
                        className="text-[#1f1b1d]/70 text-2xl md:text-2xl font-normal text-center [text-wrap:balance] mt-4 lowercase px-3"
                    >
                    ...
                    <motion.p
                        layoutId={layout ? `category-${testimonial.name}` : undefined}
                        className="text-[#1f1b1d]/70 text-xl md:text-2xl font-thin italic text-center mt-5 lowercase"
                    >
                        {testimonial.name}.
                    </motion.p>
                    <motion.p
                        className="text-[#1f1b1d]/70 text-base md:text-base font-thin italic text-center mt-1 lowercase underline underline-offset-8 decoration-1"
                    >
...
const ProfileImage = ({ src, alt, ...rest }: ImageProps) => {
    ...
    return (
        <div className="w-[90px] h-[90px] md:w-[150px] md:h-[150px] opacity-80 overflow-hidden rounded-full border-[3px] border-solid border-[rgba(59,59,59,0.6)] aspect-[1/1] flex-none saturate-[0.2] sepia-[0.46] relative">
            <Image
                className={cn(
